...
def upgrade():
    ...
    try:
        ...
        print("Table 'user__connector__instance' already exist")
    ...
    try:
        ...
        print("Table 'connector__instance' already exist")

    try:
        with op.batch_alter_table('connector', schema=None) as batch_op:
            batch_op.drop_index('ix_connector_url')
            batch_op.drop_column('url')
    except OperationalError:
        print("Column 'url' already dropepd from 'connector'")
    except KeyError:
        print("Column 'url' already dropepd from 'connector'")
    except ValueError:
        print("Column 'url' already dropepd from 'connector'")
