...
def upgrade():
    ...
    if 'nb_notes' not in existing_columns:
        op.add_column('task', sa.Column('nb_notes', sa.Integer(), nullable=True))
        op.create_index('ix_task_nb_notes', 'task', ['nb_notes'], unique=False)
