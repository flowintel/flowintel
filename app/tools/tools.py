...
def system_settings():
    ...
    system_info = {
        ...
        'app_host': getattr(config_class, 'APP_HOST', None),
        'app_port': getattr(config_class, 'APP_PORT', None),
        ...
        'footer_1_logo': current_app.config.get('FOOTER_1_LOGO', ''),
        'footer_2_logo': current_app.config.get('FOOTER_2_LOGO', ''),
