import os
from .. import db
from ..db_class.db import Case_Connector_Id, Case_Connector_Instance, Case_Template_Connector_Instance, Connector_Icon, Icon_File, Connector, Connector_Instance, Task_Connector_Id, Task_Connector_Instance, Task_Template_Connector_Instance, User_Connector_Instance
import uuid
...
def delete_connector_instance_core(iid):
    ...
    Case_Connector_Id.query.filter_by(instance_id=iid).delete()
    Task_Connector_Id.query.filter_by(instance_id=iid).delete()
