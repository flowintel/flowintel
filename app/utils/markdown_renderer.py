...
ALLOWED_ATTRIBUTES = {
    ...
    "foreignObject": ["width", "height", "x", "y", "requiredExtensions"],
    "div": ["xmlns", "style", "class"], # Mermaid text labels use inline styles
    "span": ["style", "class"],
}

ALLOWED_PROTOCOLS = ["http", "https", "mailto", "data"]

# Allow a broad set of CSS properties so mermaid layout styles (centering, transforms, alignment) survive,
# while keeping sanitizer active to avoid breaking on None.
