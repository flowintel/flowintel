...
@templating_ns.route('/case/<cid>')
@templating_ns.doc(description='Get a case template', params={'cid': 'id of a case template'})
...
@templating_ns.route('/case/title', methods=["POST"])
@templating_ns.doc(description='Get a case by title')
class GetCaseTitle(Resource):
    method_decorators = [api_required]
    @templating_ns.doc(params={"title": "Title of a case"})
    def post(self):
...
@templating_ns.route('/get_taxonomies_case/<cid>', methods=["GET"])
@templating_ns.doc(description='Get Taxonomies of a case', params={'cid': 'id of a case template'})
...
@templating_ns.route('/get_galaxies_case/<cid>', methods=["GET"])
@templating_ns.doc(description='Get Galaxies of a case', params={'cid': 'id of a case template'})
...
@templating_ns.route('/tasks')
@templating_ns.doc(description='Get all task template')
...
@templating_ns.route('/task/<tid>')
@templating_ns.doc(description='Get a task template', params={'tid': 'id of a task template'})
...
@templating_ns.route('/case/<cid>/task/<tid>')
@templating_ns.doc(description='Get a task template by case', params={'cid': 'id of a case template', 'tid': 'id of a task template'})
...
@templating_ns.route('/get_galaxies_task/<tid>', methods=["GET"])
@templating_ns.doc(description='Get Galaxies of a task', params={'tid': 'id of a task template'})
...
@templating_ns.route('/case/<cid>/move_task_up/<tid>', methods=["GET"])
@templating_ns.doc(description='Move the task up', params={"cid": "id of a case", "tid": "id of a task"})
...
@templating_ns.route('/case/<cid>/move_task_down/<tid>', methods=["GET"])
@templating_ns.doc(description='Move the task down', params={"cid": "id of a case", "tid": "id of a task"})
...
@templating_ns.route('/task/<tid>/list_subtasks', methods=['GET'])
@templating_ns.doc(description='List subtasks of a task')
...
@templating_ns.route('/task/<tid>/subtask/<sid>', methods=['GET'])
@templating_ns.doc(description='Get a subtask of a task')
...
@templating_ns.route('/<tid>/list_urls_tools', methods=['GET'])
@templating_ns.doc(description='List Urls/Tools of a task')
...
@templating_ns.route('/<tid>/url_tool/<utid>', methods=['GET'])
@templating_ns.doc(description='Get a Url/Tool of a task')
