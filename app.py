...
if args.init_db:
    ...
    with app.app_context():
        ...
        create_community_test_cases()
elif args.delete_test_data_cases:
    with app.app_context():
        from app.utils.init_community_data import delete_community_test_cases
        delete_community_test_cases()
else:
    # get_modules_list()
